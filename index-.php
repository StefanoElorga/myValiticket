...
<header>
  <nav class="navbar navbar-expand-md navbar-dark fixed-top " style="background-image:url(imgs/bk-menu.png);">
    <a class="navbar-brand" href="#">Valiticket</a>
      ...
      <div class="carousel-item active" style="height:550px;">
        ...
        <div class="container">
          <div class="carousel-caption text-left">
            ...
            <p><a class="btn btn-lg btn-primary" href="https://getbootstrap.com/docs/4.6/examples/carousel/#">Sign up today</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item " style="height:550px;">
        ...
        <div class="container">
          <div class="carousel-caption">
            ...
            <p><a class="btn btn-lg btn-primary" href="https://getbootstrap.com/docs/4.6/examples/carousel/#">Learn more</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item" style="height:550px;">
        ...
        <div class="container">
          <div class="carousel-caption text-right">
            ...
            <p><a class="btn btn-lg btn-primary" href="https://getbootstrap.com/docs/4.6/examples/carousel/#">Browse gallery</a></p>
          </div>
        </div>
      </div>
    </div>
...
<div id="speaker" class="speaker-area pt100 pb50">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title pb30">honorable speaker</h1>
                    </div>
                    <div class="col-12">
                        <div class="total-speaker-2 row">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="single-speaker shadow-box text-center">
                                    ...
                                    <h4 class="speaker-name uppercase"><strong>Patricia Morales</strong></h4>
                                    <p class="speaker-deg">Developer</p>
                                    <div class="social-icon">
                                        <ul>
                                            <li><a href="#"><i class="zmdi zmdi-facebook"></i></a></li>
                                            <li><a href="#"><i class="zmdi zmdi-behance"></i></a></li>
            ...
            <div class="map-content">
                <div class="content-body">
                    <form id="contact-form" action="https://whizthemes.com/mail-php/other/mail.php">
                        <div class="input-box">
                            <input type="text" placeholder="Name" class="info" name="con_name">
                            <input type="email" placeholder="E-mail*" class="info" name="con_email">
                            <input type="text" placeholder="Title" class="info" name="con_subject">
                            <textarea class="area-text" placeholder="Message" name="con_message"></textarea>
                        </div>
