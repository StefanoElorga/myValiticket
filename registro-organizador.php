	...
	<div style="width:50%;padding:25px;>
            ...
            <form action="registro.php" method="post" name="form" class="register-form">
              <div class="my-form-group">
                ...
                <label for="exampleInputEmail1" class="form-label">Apellido y Nombre o Empresa u Organizaci&oacute;n</label>
              </div>
              ...
              <div class="my-form-group">
                ...
                <label for="exampleInputEmail1" class="form-label">Repita Email</label>
              </div>
              ...
              <div class="my-form-group">
                ...
                <label for="exampleInputPassword1" class="form-label">Repita Password</label>
              </div>
...
<!--    <script src="https://cdn.jsdelivr.net/npm/jquery@3.5.1/dist/jquery.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>-->
    ...
    /* estilo para cada <input> y su <lable> */
.my-form-group {
  position: relative;
  font-size: 15px;
...
/* estilos para el container principal del formulario */
.register-form{
