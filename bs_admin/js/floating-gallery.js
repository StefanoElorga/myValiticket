...
function saveImageOrder(ids)
{
	...
	guardar_orden(orderString, ids);
//	document.getElementById('debug').innerHTML = 'El orden se guard&oacute; correctamente';
	
}


function saveImageOrderWeb(ids)
{
	var orderString = "";
	var objects = document.getElementsByTagName('div');
	...
	guardar_ordenweb(orderString, ids);
//	document.getElementById('debug').innerHTML = 'El orden se guard&oacute; correctamente';
...
function guardar_orden(datos, ids){
        var div=document.getElementById('debug');
		 div.innerHTML="";
		$.ajax({
		type: "GET",
		url: "guardar_orden.php",
		data: 'orden='+datos+'&ids='+ids,
...
function guardar_ordenweb(datos, ids){
        var div=document.getElementById('debug');
		 div.innerHTML="";
		$.ajax({
		type: "GET",
		url: "guardar_ordenweb.php",//sigo aqui
		data: 'orden='+datos+'&ids='+ids,
		success: function(datos){
		$('#debug').append(datos);
	  }
...
function guardar_orden2(datos, ids){
        var div=document.getElementById('debug');
		 div.innerHTML="";
		location.href="guardar_orden.php?orden="+datos+'&ids='+ids;
}

function saveImageOrderSlider()
{
	var orderString = "";
	var objects = document.getElementsByTagName('div');
	...
	guardar_orden_slider(orderString);
	//document.getElementById('debug').innerHTML = 'El orden se guard&oacute; correctamente';
	
}

function guardar_orden_slider(datos){
        var div=document.getElementById('debug');
		 div.innerHTML="";
		$.ajax({
		type: "GET",
		url: "guardar_orden_slider.php",
		data: 'orden='+datos,
		success: function(datos){
		$('#debug').append(datos);
	  }
...
function saveImageOrderdestacados()
{
	var orderString = "";
	var objects = document.getElementsByTagName('div');
	...
	guardar_orden_destacados(orderString);
	//document.getElementById('debug').innerHTML = 'El orden se guard&oacute; correctamente';
	
}

function guardar_orden_destacados(datos){
        var div=document.getElementById('debug');
		 div.innerHTML="";
		$.ajax({
		type: "GET",
		url: "guardar_orden_destacados.php",
		data: 'orden='+datos,
		success: function(datos){
		$('#debug').append(datos);
	  }
...
function saveImageOrderInversiones(ids)
{
	var orderString = "";
	var objects = document.getElementsByTagName('div');
	...
	guardar_orden_fotos_inversiones(orderString, ids);
//	document.getElementById('debug').innerHTML = 'El orden se guard&oacute; correctamente';
	
}

function guardar_orden_fotos_inversiones(datos, ids){
        var div=document.getElementById('debug');
		 div.innerHTML="";
		$.ajax({
		type: "GET",
		url: "guardar_orden_fotos_inversiones.php",
		data: 'orden='+datos+'&ids='+ids,
		success: function(datos){
		$('#debug').append(datos);
	  }
...
function saveImageOrderEntidades(ids)
{
	var orderString = "";
	var objects = document.getElementsByTagName('div');
	...
	guardar_orden_fotos_entidades(orderString, ids);
//	document.getElementById('debug').innerHTML = 'El orden se guard&oacute; correctamente';
	
}

function guardar_orden_fotos_entidades(datos, ids){
        var div=document.getElementById('debug');
		 div.innerHTML="";
		$.ajax({
		type: "GET",
		url: "guardar_orden_fotos_entidades.php",
		data: 'orden='+datos+'&ids='+ids,
		success: function(datos){
		$('#debug').append(datos);
	  }
...
function saveImageOrderSLfotos(ids)
{
	var orderString = "";
	var objects = document.getElementsByTagName('div');
	...
	guardar_orden_fotos_SL(orderString, ids);
//	document.getElementById('debug').innerHTML = 'El orden se guard&oacute; correctamente';
	
}

function guardar_orden_fotos_SL(datos, ids){
        var div=document.getElementById('debug');
		 div.innerHTML="";
		$.ajax({
		type: "GET",
		url: "guardar_orden_fotos_SL.php",
		data: 'orden='+datos+'&ids='+ids,
		success: function(datos){
		$('#debug').append(datos);
	  }
